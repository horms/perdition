...
#define PROTOCOL_MANAGESIEVE 5
#define PROTOCOL_DEFAULT PROTOCOL_POP3
#define PROTOCOL_ALL 0

#define PROTOCOL_S_OK			0x01
#define PROTOCOL_S_STARTTLS		0x02
#define PROTOCOL_S_LOGINDISABLED	0x04
#define PROTOCOL_S_SASL_PLAIN		0x08

#define PROTOCOL_S_SASL_MASK		PROTOCOL_S_SASL_PLAIN
