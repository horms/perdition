...
#define PERDITIONDB_MYSQL_DEFAULT_DBUSERCOL    "username"
#define PERDITIONDB_MYSQL_DEFAULT_DBSRVCOL    "popsrv"
#define PERDITIONDB_MYSQL_DEFAULT_DBPORTCOL    ""
...
#define PERDITIONDB_MYSQL_DBUSERCOL    6
#define PERDITIONDB_MYSQL_DBSRVCOL    7
